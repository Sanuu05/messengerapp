...
import { emploadmsg, loadmsg, loadoneuser, sendmsg } from "../action/user";
    ...
    if (msgres) {
      ...
      if (props.route.params?.type == "group") {
        socket.emit("chatMessage", {
          content: msgres,
          groupId: props.route?.params?._id,
          senderId: userad,
          type: "text",
        });
      } else {
        ...
        socket.emit("chatMessage", {
          content: msgres,
          receiverId: props.route?.params?._id,
          senderId: userad,
          type: "text",
        });
      }
        ...
        {v?.content ? (
          <Text
            ...
            style={{
              ...
              borderTopRightRadius: v?.senderId == userad ? null : 50,
              borderTopLeftRadius: 50,
              borderBottomLeftRadius: v?.senderId == userad ? 50 : null,
            }}
          >
            {v?.content}
          </Text>
            ...
            <View style={styles.centeredView1}>
              <View style={styles.modalView1}>
                ...
                >
                  ...
                  />
                  <Text
                    style={{ fontSize: 30, fontFamily: "Alegreya_700Bold" }}
                  >
                    {filter?.name}
                  </Text>
                  <Text
                    style={{ fontSize: 20, fontFamily: "Alegreya_400Regular" }}
                  >
                    {filter?.email}
                  </Text>
                </View>
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              ...
              >
                ...
                >
                  ...
                  >
                    <Text
                      style={{ fontSize: 18, fontFamily: "Alegreya_700Bold" }}
                    >
                      Cancel
                    </Text>
            ...
            >
              {(msg?.length == 0 || msg?.length == undefined) && loading ? (
                <View
                  style={{
                    height: height - 100,
                    display: "flex",
          ...
          >
            ...
            >
              ...
              <TextInput
                ...
                onChangeText={(text) => setmsgres(text)}
              />
